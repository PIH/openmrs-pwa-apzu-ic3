...
import {ENCOUNTER_TYPES, EID_ALERTS } from "../../constants";
...
const eidFilter = patient => {
  return ( ((typeof patient.alert !== 'undefined') && (patient.alert !== null)) ? patient.alert.some(a => EID_ALERTS.indexOf(a) >= 0) : false );
};
